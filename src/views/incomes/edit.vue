...
<template>
    ...
    <CCard>
        ...
        <CCardHeader component="h5">Edit Income</CCardHeader>
        <CCardBody>
            <CForm>
                <CRow>
                    <CCol xs="12" sm="6">
  ...
  export default {
    ...
    methods:{
        save(){
            if(this.name)
            {
                let url = 'http://localhost/financial/api/incomes/update.php';
        ...
        async  getData(id){
            let url = 'http://localhost/financial/api/incomes/getOne.php';
