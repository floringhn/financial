...
<template>
    ...
    <CCard>
        ...
        <CCardHeader component="h5">Edit user</CCardHeader>
        <CCardBody>
            <CForm>
                <CRow>
                    <CCol xs="12" sm="6">
  ...
  export default {
    ...
    methods:{
        save(){
            if(this.name)
            {
                let url = 'http://localhost/financial/api/users/update.php';
        ...
        async  getData(id){
            let url = 'http://localhost/financial/api/users/getOne.php';
