...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/income/create',
        name: 'Create Income',
        component: () => import('@/views/incomes/create.vue'),
      },
      {
        path: '/income/edit/:id',
        name: 'Edit Income',
      ...
      {
        path: '/budget-management/set/:id',
        name: 'Set Budget Management',
        component: () => import('@/views/budgetManagement/set.vue'),
      },
      {
        path: '/goal/edit/:id',
        name: 'Edit Budget Management',
        component: () => import('@/views/goals/edit.vue'),
      },
      {
        path: '/users',
        name: 'Users',
      ...
      },
      {
        path: '/goal/create',
        name: 'Create Goal',
        component: () => import('@/views/goals/create.vue'),
      },
      {
...
router.beforeEach((to, from, next) => {
  if(to.name != 'Login') {
    let url = 'http://localhost/financial/api/auth-file/check-login.php';
